...
if nav=='Predictions':
    ...
    if submit:
        ...
        ann.add(tf.keras.layers.Dense(units=17, activation='relu'))  # Input layer with 17 features
        ann.add(tf.keras.layers.Dense(units=6, activation='relu'))
        ann.add(tf.keras.layers.Dense(units=3, activation='softmax'))  # Output layer with 3 classes and softmax activation
